<li class="breadcrumb-item active cl-control" aria-current="page">Sản phẩm bán chạy nhất</li>
</nav>
</div>
</section>
                            ...
                            <nav class="nav-category navbar-toggleable-md">
                                <ul class="nav navbar-pills">
                                    ...
                                    <li class="nav-item lv1">
                                        <a href="<?= BASE_URL ?>/product_type_sale/index/<?= $item['cate_id'] ?>"
                                            class="nav-link"><?= $item['cate_name'] ?></a>
                                    </li>
                                    <?php endforeach; ?>
                            ...
                            <div class="not-dqowl wrp_list_product">
                                ...
                                <div class="item_small">
                                    <div class="product-mini-item clearfix on-sale">
                                        <a href="<?= BASE_URL?>/product_detail/index/<?= $item['product_id']?>"
                                            class="product-img">
                                            <img src="<?= IMGAE_DISPLAY ?>/backend/image/products/<?= $item['product_image'] ?>"
                                                alt="">
                                        </a>
                                        <div class="product-info">
                                            <h3>
                                                <a href=""
                                                    class="product-name text3line"><?= $item['product_name'] ?></a>
                                            </h3>
                                            <div class="price-box">
                                                <span class="price">
                                        ...
                                        <div class="product-box-h">
                                            <div class="border_in">
                                                ...
                                                <div class="product-thumbnail">
                                                    <a class="image_link"
                                                        href="<?= BASE_URL?>/product_detail/index/<?= $item['product_id']?>"
                                                        title="<?= $item['product_name'] ?>">
                                                        <img class="lazyload loaded"
                                                            src="<?= IMGAE_DISPLAY ?>/backend/image/products/<?= $item['product_image'] ?>">
                                                    </a>
                                                    <div class="pro_action">
                                                        <form action="" method="post">
                                                            <input type="hidden" name="<?= $item['product_id'] ?>"
                                                                value="1">
                                                            <button type="submit" name="btn_cart"
                                                                class="btn btn-cart hidden ">Thêm vào giỏ hàng </button>
                                                        </form>
                                                    </div>
                                                </div>
                                                <div class="product-info">
